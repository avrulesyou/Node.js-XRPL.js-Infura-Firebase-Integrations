...
import type { ApplicationDetails, CreatePayload, AnyJson, CuratedAssetsResponse, PossibleKycStatuses, XrplTransaction, NftokenDetail, RatesResponse, UserTokenValidity } from './types';
export declare class Meta {
    ...
    private authorize;
    call<T>(endpoint: string, httpMethod?: string, data?: CreatePayload | AnyJson): Promise<T> | never;
    ...
    getNftokenDetail(tokenId: string): Promise<NftokenDetail> | never;
